...
const Navbar = () => {
    ...
    return (
        <div className="backdrop-filter backdrop-blur-lg bg-opacity-30  bg-black sticky z-50 top-0 " >
            <nav className="flex items-center  mx-auto animate__animated animate__fadeIn max-w-7xl top-0  justify-between flex-wrap   py-6">
